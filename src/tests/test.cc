...
void CompareMatrix(S21Matrix matrix1, S21Matrix matrix2);
...
TEST(test_operator_brackets, test18) {
    S21Matrix matrix1(3,3);
...
TEST(test_operator_add_eq, test25) {
    S21Matrix matrix1(3,3);
    matrix1(1, 1) = 2;
    S21Matrix matrix2(3,3);
    matrix2(1, 1) = 2;
...
TEST(test_operator_sub_eq, test26) {
    S21Matrix matrix1(3,3);
    matrix1(1, 1) = 2;
    S21Matrix matrix2(3,3);
    matrix2(1, 1) = 1;
...
TEST(test_operator_mulmatr_eq, test28) {
    S21Matrix matrix1(3,3);
    matrix1(1, 1) = 2;
    S21Matrix matrix2(3,3);
    matrix2(1, 1) = 2;
...
TEST(test_operator_mulnum_eq, test29) {
    S21Matrix matrix1(3,3);
    matrix1(1, 1) = 2;
    double d = 2;
    S21Matrix matrix_result(3,3);
...
TEST(test_operator_eq_eq, test30) {
    S21Matrix matrix1(3,3);
    matrix1(1, 1) = 2;
    S21Matrix matrix2(3,3);
    matrix2(1, 1) = 2;
...
TEST(test_move, test31) {
  int rows = 5, cols = 5;
  S21Matrix matrix1(rows, cols);
  S21Matrix matrix2(std::move(matrix1));
  EXPECT_EQ(matrix1.get_row_size(), 0);
  EXPECT_EQ(matrix1.get_col_size(), 0);
  EXPECT_EQ(matrix2.get_row_size(), rows);
  EXPECT_EQ(matrix2.get_col_size(), cols);
}
...
void CompareMatrix(S21Matrix matrix_1, S21Matrix matrix_2) {
  EXPECT_EQ(matrix_2.get_row_size(), matrix_1.get_row_size());
  EXPECT_EQ(matrix_2.get_col_size(), matrix_1.get_col_size());
  for (int i = 0; i < matrix_1.get_row_size(); ++i)
    for (int j = 0; j < matrix_2.get_col_size(); ++j)
